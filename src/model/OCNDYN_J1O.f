...
! Making these the default for planet_1.0 runs
! Done here once rather than in multiple rundecks
#define ODIFF_TRIDIAG_CYCLIC
...
C**** Fix to 1 (instead of 4) for planets w/o antarctica
      J1O=1
