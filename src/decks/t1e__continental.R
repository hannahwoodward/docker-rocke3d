! Trappist1e Continental deck, Hannah Woodward 2024
...
!! ----- CUSTOM TOPOGRAPHY
TOPO=450ma/Z4x5_450Ma_TOPO_OC.nc
OSTRAITS=450ma/OSTRAITS_72x46_450Ma_MaskA.nml
RVR=450ma/RD_450Ma_4x5_LowestPath.nc
NAMERVR=RD_modelE_M.names_btub0.txt
VEG=450ma/V72X46_450Ma_T2.nc
SOIL=450ma/S72X46_450Ma_B.nc
TOP_INDEX=450ma/TOP_INDEX_72x46_450Ma.nc ! only used if #define DO_TOPMODEL_RUNOFF
...
SOILCARB_global=450ma/soilcarb_top30cm_4x5_450Ma_VegB.nc
...
!! ----- UPDATE THE LABEL
Label and Namelist:
t1e__continental (1880 atm.,the current modelE version)
