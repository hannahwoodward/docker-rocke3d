! Trappist1e Aquaplanet dynamic deck, Hannah Woodward 2024
...
! - ocean: dynamic coupled to GISS ocean model (Russell - Schmidt)
! - radiation: planet (SOCRATES)
! - initial conditions:
!    - atmosphere: 300K isothermal temp, zero water vapor, 1000mb -> 0.1mb
!    - ocean: 300K isothermal temp, 899m depth, 13 layers
...
!OCNDYN_J1O OCNDYN2                    ! dynamic ocean routines [OCNDYN]
...
OIC=OIC4X5LD.Z12.gas1.CLEV94.DEC01.aqua2.nc
...
TOPO_OC=OZ72X46N_gas.1_nocasp.aqua2.nc
...
!! ----- UPDATE THE LABEL
Label and Namelist:
t1e__aqua_dyn (1880 atm.,the current modelE version)
...
OTIDE=0
!meso_diffusitivity_const=1000.
meso_diffusivity_const=1200. ! 600.
...
DTsrc=1756.8        ! cannot be changed after a run has been started
DT=225.
...
KRSF=1200           ! 0: no output; X: save .rsf at the beginning of every X month
...
Ndisk=480
nrad=2              ! radiation (every NRAD'th physics time step)
ndigits_year=5
!nmonav=1
!keep_params=1
